      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute inset-0" style={{
            backgroundImage: `linear-gradient(30deg, transparent 49%, var(--primary) 49%, var(--primary) 51%, transparent 51%)`,
        ...
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-1/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-[color:var(--primary)] to-transparent"></div>
          <div className="absolute top-1/2 left-0 w-full h-px bg-gradient-to-r from-transparent via-[rgba(212,175,55,0.85)] to-transparent"></div>
          <div className="absolute top-3/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-[color:var(--primary)] to-transparent"></div>
        </div>
        
        {/* Luces neón */}
        <div className="absolute -top-20 -left-20 w-60 h-60 bg-[color:var(--primary)]/10 rounded-full blur-3xl"></div>
        <div className="absolute -bottom-20 -right-20 w-60 h-60 bg-[rgba(212,175,55,0.08)] rounded-full blur-3xl"></div>
        
        {/* Puntos de conexión */}
        <div className="absolute top-1/4 left-1/4 w-2 h-2 bg-[color:var(--primary)] rounded-full"></div>
        <div className="absolute top-1/2 right-1/4 w-2 h-2 bg-[rgba(212,175,55,0.95)] rounded-full"></div>
        <div className="absolute top-3/4 left-1/3 w-2 h-2 bg-[color:var(--primary)] rounded-full"></div>
      </div>
            ...
            <div className="p-6">
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="relative">
                  {/* Efecto de anillo */}
                  <div className="absolute -inset-4 bg-gradient-to-r from-primary/20 to-[rgba(212,175,55,0.12)] rounded-full blur-md"></div>
                  ...
                  <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-4 border border-gray-700 shadow-lg">
                        ...
                        <div className="h-full rounded-lg overflow-hidden bg-gray-950">
                          <div className="relative h-full">
                            ...
                            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                              <div className="w-12 h-12 bg-[color:var(--primary)] rounded-xl flex items-center justify-center shadow-lg">
                    ...
                    {/* Partículas flotantes */}
                      <Sparkles className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-5 h-5 text-[rgba(212,175,55,0.6)]" />
                  </div>
                </div>
                ...
                <div className="flex-1">
                  <div className="space-y-4">
                    {/* Header */}
                    <div>
                      <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-primary/50 to-[rgba(212,175,55,0.12)] text-[rgba(212,175,55,0.85)] rounded-lg text-sm font-medium mb-3 border border-primary/30">
                      ...
                      <h3 className="text-xl font-bold text-white mb-2">
                        Descarga <span className="bg-gradient-to-r from-[color:var(--primary)] to-[rgba(212,175,55,0.8)] bg-clip-text text-transparent">9mx</span>
                      </h3>
              ...
              <div className="mt-6 pt-4 border-t border-gray-800">
                <div className="flex flex-wrap items-center justify-between gap-2 text-xs text-gray-500">
                  ...
                  <div className="flex items-center gap-2">
                    <svg className="w-3 h-3 text-[rgba(212,175,55,0.85)]" fill="currentColor" viewBox="0 0 20 20">
